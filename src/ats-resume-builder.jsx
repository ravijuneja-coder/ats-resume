...
function HomePage({ setPage }) {
  ...
  return (
    <div className="app-bg">
      ...
      {/* Resume Showcase */}
      <section style={{ padding: "90px 24px", background: "linear-gradient(180deg, var(--c-bg) 0%, #EEF2FF 100%)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>

          <div style={{ textAlign: "center", marginBottom: 60 }}>
            <div className="badge badge-blue" style={{ marginBottom: 14, fontSize: 12 }}>
              <Icon.Sparkles /> Designed for every career stage
            </div>
            <h2 className="font-display" style={{ fontSize: "clamp(28px, 4vw, 48px)", fontWeight: 800, margin: "0 0 14px", lineHeight: 1.1 }}>
              Resumes that <span className="grad-text">actually get interviews</span>
            </h2>
            <p className="app-text2" style={{ fontSize: 17, maxWidth: 520, margin: "0 auto", lineHeight: 1.6 }}>
              Beautiful, ATS-safe designs for every industry. Stand out without sacrificing compatibility.
            </p>
          </div>

          {/* Bento: left tall (no photo) + 2 middle stacked (photo) + right tall (photo) */}
          <div style={{ display: "grid", gridTemplateColumns: "1.15fr 1fr 1.15fr", gridTemplateRows: "auto auto", gap: 20, alignItems: "start" }}>

            {/* ── CARD 1 — No photo, dark/navy, tall left ── */}
            <div className="card-hover" onClick={() => setPage(PAGES.TEMPLATES)} style={{
              gridRow: "1 / 3", borderRadius: 22, overflow: "hidden", cursor: "pointer",
              boxShadow: "0 24px 64px rgba(15,23,42,0.22)", border: "1px solid rgba(255,255,255,0.07)",
              background: "#0F172A",
            }}>
              {/* Browser chrome */}
              <div style={{ padding: "10px 14px", background: "#1E293B", display: "flex", alignItems: "center", gap: 10, borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                <div style={{ display: "flex", gap: 5 }}>
                  <div style={{ width: 10, height: 10, borderRadius: "50%", background: "#FF5F57" }} />
                  <div style={{ width: 10, height: 10, borderRadius: "50%", background: "#FEBC2E" }} />
                  <div style={{ width: 10, height: 10, borderRadius: "50%", background: "#28C840" }} />
                </div>
                <div style={{ flex: 1, background: "#0F172A", borderRadius: 6, padding: "4px 10px", fontSize: 10, color: "#475569", display: "flex", alignItems: "center", gap: 5 }}>
                ...
                <div style={{ background: "#064E3B", border: "1px solid #059669", borderRadius: 99, padding: "3px 8px", flexShrink: 0 }}>
                  <span style={{ fontSize: 8, fontWeight: 700, color: "#34D399" }}>✓ ATS 94/100</span>
                </div>
              </div>
              ...
              <div style={{ padding: "20px 20px 26px" }}>
                ...
                <div style={{ marginBottom: 16 }}>
                  <div style={{ fontSize: 22, fontWeight: 800, color: "#F1F5F9", fontFamily: "var(--font-display)", letterSpacing: "-0.02em", lineHeight: 1.1 }}>Alex Morgan</div>
                  <div style={{ fontSize: 12, color: "#64748B", fontWeight: 500, marginTop: 3 }}>Senior Software Engineer</div>
                  <div style={{ fontSize: 10, color: "#334155", marginTop: 6, display: "flex", flexWrap: "wrap", gap: 10 }}>
                    <span>alex@email.com</span><span>·</span><span>San Francisco, CA</span>
                  </div>
                </div>
                ...
                {/* Summary */}
                <div style={{ marginBottom: 14 }}>
                  <div style={{ fontSize: 9, fontWeight: 700, color: "#38BDF8", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 6 }}>Professional Summary</div>
                  <div style={{ fontSize: 10, color: "#94A3B8", lineHeight: 1.7 }}>
                    Results-driven engineer with 6+ years building scalable distributed systems. Reduced latency by 40% and shipped features serving 10M+ users.
                  </div>
                </div>

                {/* Experience */}
                <div style={{ marginBottom: 14 }}>
                  <div style={{ fontSize: 9, fontWeight: 700, color: "#38BDF8", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 8 }}>Experience</div>
                  <div style={{ marginBottom: 10 }}>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                      <div style={{ fontSize: 11, fontWeight: 700, color: "#E2E8F0" }}>Senior Software Engineer</div>
                      <div style={{ fontSize: 9, color: "#475569" }}>2021 – Now</div>
                    </div>
                    <div style={{ fontSize: 10, color: "#38BDF8", marginTop: 2, fontWeight: 600 }}>Stripe</div>
                    <div style={{ fontSize: 9, color: "#64748B", marginTop: 5, lineHeight: 1.6 }}>
                      • Reduced p99 latency by 42% across core payment APIs<br/>
                      • Built fraud detection processing 2M+ events/day
                    </div>
                  </div>
                  <div>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                      <div style={{ fontSize: 11, fontWeight: 700, color: "#E2E8F0" }}>Software Engineer II</div>
                      <div style={{ fontSize: 9, color: "#475569" }}>2018 – 2021</div>
                    </div>
                    <div style={{ fontSize: 10, color: "#38BDF8", marginTop: 2, fontWeight: 600 }}>Airbnb</div>
                    <div style={{ fontSize: 9, color: "#64748B", marginTop: 5 }}>• Increased booking conversion by 18% ($240M ARR)</div>
                  </div>
                </div>

                {/* Skills */}
                <div style={{ marginBottom: 16 }}>
                  <div style={{ fontSize: 9, fontWeight: 700, color: "#38BDF8", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 8 }}>Skills</div>
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 5 }}>
                    {["TypeScript", "Go", "Python", "React", "Node.js", "PostgreSQL", "AWS", "Kubernetes"].map(s => (
                      <span key={s} style={{ fontSize: 8, padding: "3px 8px", borderRadius: 99, background: "rgba(56,189,248,0.1)", border: "1px solid rgba(56,189,248,0.22)", color: "#38BDF8", fontWeight: 600 }}>{s}</span>
                    ))}
                  </div>
                </div>

                {/* ATS Score card */}
                <div style={{ display: "flex", alignItems: "center", gap: 12, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 12, padding: "12px 14px" }}>
                  <div style={{ background: "linear-gradient(135deg, #FFF7ED, #FEF3C7)", border: "2px solid #F59E0B", borderRadius: 10, padding: "8px 12px", textAlign: "center" }}>
                    <div style={{ fontSize: 22, fontWeight: 900, color: "#92400E", lineHeight: 1 }}>94</div>
                    <div style={{ fontSize: 7, color: "#B45309", fontWeight: 700, marginTop: 2, textTransform: "uppercase" }}>ATS Score</div>
                  </div>
                  <div>
                    <div style={{ fontSize: 11, fontWeight: 700, color: "#34D399" }}>✓ ATS Passed</div>
                    <div style={{ fontSize: 9, color: "#64748B", marginTop: 2 }}>Top 5% of resumes</div>
                    <div style={{ fontSize: 9, color: "#475569", marginTop: 4 }}>3 recruiters viewed · last 24h</div>
                  </div>
                </div>
              </div>
            </div>

            {/* ── CARD 2 — With photo, purple, middle top ── */}
            <div className="card-hover" onClick={() => setPage(PAGES.TEMPLATES)} style={{
              borderRadius: 20, overflow: "hidden", cursor: "pointer",
              boxShadow: "0 12px 40px rgba(124,58,237,0.16)", border: "1.5px solid #EDE9FE",
              background: "#fff",
            }}>
              {/* Browser chrome */}
              <div style={{ padding: "8px 12px", background: "#F5F3FF", display: "flex", alignItems: "center", gap: 8, borderBottom: "1px solid #EDE9FE" }}>
                <div style={{ display: "flex", gap: 4 }}>
                  <div style={{ width: 9, height: 9, borderRadius: "50%", background: "#FF5F57" }} />
                  <div style={{ width: 9, height: 9, borderRadius: "50%", background: "#FEBC2E" }} />
                  <div style={{ width: 9, height: 9, borderRadius: "50%", background: "#28C840" }} />
                </div>
                <div style={{ flex: 1, background: "#EDE9FE", borderRadius: 5, padding: "3px 8px", fontSize: 9, color: "#7C3AED", textAlign: "center" }}>
                  resumeai.app/builder
                </div>
              </div>

              {/* Purple header with photo */}
              <div style={{ background: "linear-gradient(135deg, #7C3AED 0%, #5B21B6 100%)", padding: "16px", position: "relative" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <div style={{ width: 48, height: 48, borderRadius: "50%", border: "2.5px solid rgba(255,255,255,0.5)", overflow: "hidden", flexShrink: 0, background: "#5B21B6" }}>
                    <img src={DUMMY_AVATAR} alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                  </div>
                  <div>
                    <div style={{ fontSize: 15, fontWeight: 800, color: "#fff", fontFamily: "var(--font-display)" }}>Priya Sharma</div>
                    <div style={{ fontSize: 10, color: "#C4B5FD", marginTop: 1 }}>Product Manager</div>
                    <div style={{ fontSize: 9, color: "#A78BFA", marginTop: 3 }}>San Francisco · google.com/in/priya</div>
                  </div>
                </div>
                <div style={{ position: "absolute", top: 10, right: 10, background: "rgba(255,255,255,0.2)", border: "1px solid rgba(255,255,255,0.35)", borderRadius: 99, padding: "3px 9px" }}>
                  <span style={{ fontSize: 9, fontWeight: 700, color: "#fff" }}>✓ ATS Optimized</span>
                </div>
              </div>

              {/* Body */}
              <div style={{ padding: "12px 14px 16px" }}>
                <div style={{ fontSize: 8, fontWeight: 700, color: "#7C3AED", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 6 }}>Experience</div>
                <div style={{ marginBottom: 6 }}>
                  <div style={{ fontSize: 11, fontWeight: 700, color: "#1E1B4B" }}>Senior Product Manager</div>
                  <div style={{ fontSize: 9, color: "#7C3AED", fontWeight: 600 }}>Google · 2020 – Present</div>
                  <div style={{ fontSize: 9, color: "#64748B", marginTop: 4, lineHeight: 1.5 }}>Launched 3 products with $240M ARR impact, managing cross-functional teams of 20+</div>
                </div>
                <div style={{ display: "flex", flexWrap: "wrap", gap: 4, marginTop: 10 }}>
                  {["Roadmapping", "Agile", "Analytics", "SQL", "Figma"].map(s => (
                    <span key={s} style={{ fontSize: 8, padding: "2px 7px", borderRadius: 99, background: "#F5F3FF", border: "1px solid #DDD6FE", color: "#6D28D9", fontWeight: 600 }}>{s}</span>
                  ))}
                </div>
                <div style={{ marginTop: 12, background: "linear-gradient(135deg, #FFF7ED, #FEF3C7)", border: "1px solid #F59E0B", borderRadius: 8, padding: "7px 10px", display: "flex", alignItems: "center", gap: 8 }}>
                  <span style={{ fontSize: 18, fontWeight: 900, color: "#92400E" }}>91%</span>
                  <div>
                    <div style={{ fontSize: 9, fontWeight: 700, color: "#B45309" }}>Job Match Score</div>
                    <div style={{ fontSize: 8, color: "#92400E" }}>vs. Job Description</div>
                  </div>
                </div>
              </div>
            </div>

            {/* ── CARD 3 — With photo, rose/warm, middle bottom ── */}
            <div className="card-hover" onClick={() => setPage(PAGES.TEMPLATES)} style={{
              borderRadius: 20, overflow: "hidden", cursor: "pointer",
              boxShadow: "0 12px 40px rgba(244,63,94,0.13)", border: "1.5px solid #FFE4E6",
              background: "#fff",
            }}>
              {/* Browser chrome */}
              <div style={{ padding: "8px 12px", background: "#FFF1F2", display: "flex", alignItems: "center", gap: 8, borderBottom: "1px solid #FFE4E6" }}>
                <div style={{ display: "flex", gap: 4 }}>
                  <div style={{ width: 9, height: 9, borderRadius: "50%", background: "#FF5F57" }} />
                  <div style={{ width: 9, height: 9, borderRadius: "50%", background: "#FEBC2E" }} />
                  <div style={{ width: 9, height: 9, borderRadius: "50%", background: "#28C840" }} />
                </div>
                <div style={{ flex: 1, background: "#FFE4E6", borderRadius: 5, padding: "3px 8px", fontSize: 9, color: "#E11D48", textAlign: "center" }}>
                  resumeai.app/builder
                </div>
              </div>

              {/* Split header: photo left, info right */}
              <div style={{ display: "flex", background: "linear-gradient(135deg, #FFF1F2, #FFE4E6)", padding: "14px 14px 14px" }}>
                <div style={{ width: 52, height: 52, borderRadius: 14, border: "2.5px solid rgba(244,63,94,0.4)", overflow: "hidden", flexShrink: 0, marginRight: 12 }}>
                  <img src={DUMMY_AVATAR} alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                </div>
                <div>
                  <div style={{ fontSize: 14, fontWeight: 800, color: "#881337", fontFamily: "var(--font-display)" }}>Sofia Rodriguez</div>
                  <div style={{ fontSize: 10, color: "#E11D48", marginTop: 1, fontWeight: 600 }}>Data Scientist</div>
                  <div style={{ fontSize: 8, color: "#9F1239", marginTop: 3 }}>sofia@email.com · New York, NY</div>
                  <div style={{ marginTop: 5 }}>
                    <span style={{ fontSize: 8, padding: "2px 7px", borderRadius: 99, background: "#FFE4E6", border: "1px solid #FECDD3", color: "#E11D48", fontWeight: 700 }}>✓ ATS 88/100</span>
                  </div>
                </div>
              </div>
              ...
              <div style={{ padding: "10px 14px 16px" }}>
                <div style={{ fontSize: 8, fontWeight: 700, color: "#E11D48", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 6 }}>Experience</div>
                <div style={{ fontSize: 11, fontWeight: 700, color: "#1F2937" }}>Lead Data Scientist</div>
                <div style={{ fontSize: 9, color: "#E11D48", fontWeight: 600 }}>Meta AI · 2022 – Present</div>
                <div style={{ fontSize: 9, color: "#64748B", marginTop: 3, lineHeight: 1.5 }}>Built ML models improving content recommendation CTR by 35%</div>
                <div style={{ display: "flex", flexWrap: "wrap", gap: 4, marginTop: 10 }}>
                  {["Python", "TensorFlow", "PyTorch", "Spark", "SQL"].map(s => (
                    <span key={s} style={{ fontSize: 8, padding: "2px 7px", borderRadius: 99, background: "#FFF1F2", border: "1px solid #FECDD3", color: "#BE123C", fontWeight: 600 }}>{s}</span>
                  ))}
                </div>
              </div>
            </div>

            {/* ── CARD 4 — With photo, teal sidebar, tall right ── */}
            <div className="card-hover" onClick={() => setPage(PAGES.TEMPLATES)} style={{
              gridRow: "1 / 3", borderRadius: 22, overflow: "hidden", cursor: "pointer",
              boxShadow: "0 24px 64px rgba(13,148,136,0.16)", border: "1.5px solid #CCFBF1",
              background: "#fff",
            }}>
              {/* Browser chrome */}
              <div style={{ padding: "9px 13px", background: "#F0FDFA", display: "flex", alignItems: "center", gap: 9, borderBottom: "1px solid #CCFBF1" }}>
                <div style={{ display: "flex", gap: 4 }}>
                  <div style={{ width: 9, height: 9, borderRadius: "50%", background: "#FF5F57" }} />
                  <div style={{ width: 9, height: 9, borderRadius: "50%", background: "#FEBC2E" }} />
                  <div style={{ width: 9, height: 9, borderRadius: "50%", background: "#28C840" }} />
                </div>
                <div style={{ flex: 1, background: "#CCFBF1", borderRadius: 5, padding: "3px 8px", fontSize: 9, color: "#0D9488", textAlign: "center" }}>
                  resumeai.app/builder
                </div>
                <div style={{ background: "#ECFDF5", border: "1px solid #6EE7B7", borderRadius: 99, padding: "3px 8px", flexShrink: 0 }}>
                  <span style={{ fontSize: 8, fontWeight: 700, color: "#065F46" }}>✓ ATS 92/100</span>
                </div>
              </div>

              {/* Two-column layout: teal sidebar + content */}
              <div style={{ display: "flex", height: "calc(100% - 38px)" }}>
                {/* Teal sidebar */}
                <div style={{ width: 90, background: "linear-gradient(180deg, #0D9488 0%, #0F766E 100%)", padding: "18px 12px", display: "flex", flexDirection: "column", alignItems: "center", flexShrink: 0 }}>
                  {/* Photo */}
                  <div style={{ width: 58, height: 58, borderRadius: "50%", border: "3px solid rgba(255,255,255,0.4)", overflow: "hidden", marginBottom: 10 }}>
                    <img src={DUMMY_AVATAR} alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                  </div>

                  {/* Contact */}
                  <div style={{ textAlign: "center", marginBottom: 14 }}>
                    <div style={{ fontSize: 10, fontWeight: 800, color: "#fff", fontFamily: "var(--font-display)", lineHeight: 1.2 }}>Marcus Chen</div>
                    <div style={{ fontSize: 8, color: "#99F6E4", marginTop: 3 }}>UX Designer</div>
                  </div>

                  <div style={{ width: "100%", height: 1, background: "rgba(255,255,255,0.15)", marginBottom: 12 }} />

                  {/* Skills sidebar */}
                  <div style={{ fontSize: 7, fontWeight: 700, color: "#99F6E4", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 7, alignSelf: "flex-start" }}>Skills</div>
                  {["Figma", "Framer", "React", "Prototyping", "Research", "CSS"].map(s => (
                    <div key={s} style={{ fontSize: 8, color: "#CCFBF1", marginBottom: 4, alignSelf: "flex-start", display: "flex", alignItems: "center", gap: 4 }}>
                      <div style={{ width: 3, height: 3, borderRadius: "50%", background: "#2DD4BF", flexShrink: 0 }} />
                      {s}
                    </div>
                  ))}

                  <div style={{ width: "100%", height: 1, background: "rgba(255,255,255,0.15)", margin: "12px 0" }} />
                  <div style={{ fontSize: 7, fontWeight: 700, color: "#99F6E4", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 7, alignSelf: "flex-start" }}>Languages</div>
                  {["English", "Mandarin"].map(s => (
                    <div key={s} style={{ fontSize: 8, color: "#CCFBF1", marginBottom: 4, alignSelf: "flex-start" }}>{s}</div>
                  ))}
                </div>
                ...
                <div style={{ flex: 1, padding: "16px 14px", overflowY: "hidden" }}>
                  ...
                  <div style={{ background: "#F0FDFA", border: "1px solid #CCFBF1", borderRadius: 10, padding: "10px 12px", marginBottom: 14 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
                      <div style={{ width: 20, height: 20, borderRadius: "50%", background: "linear-gradient(135deg, #0D9488, #0F766E)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <Icon.Sparkles style={{ width: 10, height: 10, color: "#fff" }} />
                      </div>
                      <div style={{ fontSize: 10, fontWeight: 700, color: "#0F766E" }}>AI Assistant</div>
                      <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 3 }}>
                        <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#10B981" }} />
                        <span style={{ fontSize: 8, color: "#0D9488", fontWeight: 600 }}>Active</span>
                      </div>
                    </div>
                    {[
                      { text: "Add metrics to bullet #2", color: "#0D9488", bg: "#ECFDF5", border: "#6EE7B7" },
                      { text: "Include 'Figma' in skills", color: "#0F766E", bg: "#F0FDFA", border: "#99F6E4" },
                      { text: "Strengthen portfolio link", color: "#0D9488", bg: "#ECFDF5", border: "#6EE7B7" },
                    ].map((s, i) => (
                      <div key={i} style={{ fontSize: 9, color: s.color, background: s.bg, border: `1px solid ${s.border}`, borderRadius: 6, padding: "5px 8px", marginBottom: 4, display: "flex", alignItems: "center", gap: 5 }}>
                        <span style={{ color: "#F59E0B" }}>⚡</span> {s.text}
                      </div>
                    ))}
                  </div>

                  {/* Experience */}
                  <div style={{ fontSize: 8, fontWeight: 700, color: "#0D9488", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 7 }}>Experience</div>
                  <div style={{ marginBottom: 10 }}>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                      <div style={{ fontSize: 11, fontWeight: 700, color: "#134E4A" }}>Senior UX Designer</div>
                      <div style={{ fontSize: 9, color: "#94A3B8" }}>2021 – Now</div>
                    </div>
                    <div style={{ fontSize: 9, color: "#0D9488", fontWeight: 600 }}>Airbnb</div>
                    <div style={{ fontSize: 9, color: "#64748B", marginTop: 4, lineHeight: 1.5 }}>
                      • Redesigned checkout flow, +28% conversion<br/>
                      • Led design system used by 40+ engineers
                    </div>
                  </div>
                  <div style={{ marginBottom: 12 }}>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                      <div style={{ fontSize: 11, fontWeight: 700, color: "#134E4A" }}>UX Designer</div>
                      <div style={{ fontSize: 9, color: "#94A3B8" }}>2019 – 2021</div>
                    </div>
                    <div style={{ fontSize: 9, color: "#0D9488", fontWeight: 600 }}>Spotify</div>
                    <div style={{ fontSize: 9, color: "#64748B", marginTop: 4 }}>• Won internal design award 2020</div>
                  </div>

                  {/* Education */}
                  <div style={{ fontSize: 8, fontWeight: 700, color: "#0D9488", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 7 }}>Education</div>
                  <div style={{ fontSize: 11, fontWeight: 700, color: "#134E4A" }}>B.Des Interaction Design</div>
                  <div style={{ fontSize: 9, color: "#0D9488", fontWeight: 600 }}>RISD · 2019</div>

                  {/* Score */}
                  <div style={{ marginTop: 14, background: "#F0FDFA", border: "1px solid #CCFBF1", borderRadius: 10, padding: "8px 10px", display: "flex", alignItems: "center", gap: 8 }}>
                    <div style={{ background: "#ECFDF5", border: "2px solid #059669", borderRadius: 8, padding: "5px 10px", textAlign: "center" }}>
                      <div style={{ fontSize: 18, fontWeight: 900, color: "#065F46", lineHeight: 1 }}>92</div>
                      <div style={{ fontSize: 7, color: "#059669", fontWeight: 700 }}>ATS</div>
                    </div>
                    <div>
                      <div style={{ fontSize: 10, fontWeight: 700, color: "#0F766E" }}>✓ ATS Passed</div>
                      <div style={{ fontSize: 9, color: "#64748B" }}>Top 8% of resumes</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div style={{ textAlign: "center", marginTop: 52 }}>
            <button className="btn btn-primary btn-lg" onClick={() => setPage(PAGES.REGISTER)} style={{ marginRight: 12 }}>
              <Icon.Sparkles /> Build Your Resume Free
            </button>
