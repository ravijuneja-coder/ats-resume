      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: 20, position: "relative" }}>
        ...
        <div className="card fade-in" style={{ width: "100%", maxWidth: 420, padding: "40px 36px", boxShadow: "0 24px 60px var(--c-shadow)", border: "1px solid var(--c-border)", overflow: "hidden" }}>
          ...
          >
            <div style={{ textAlign: "center", marginBottom: 32 }}>
              <motion.div
                style={{ width: 56, height: 56, borderRadius: 16, background: "linear-gradient(135deg, var(--c-accent) 0%, #8B5CF6 100%)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 18px", color: "#fff", boxShadow: "0 10px 24px var(--c-glow)" }}
                initial={reduceMotion ? false : { scale: 0.7, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
                transition={{ duration: 0.4, delay: 0.1, ease: EASE_OUT }}
              >
                <span style={{ transform: "scale(1.3)", display: "flex" }}><Icon.FileText /></span>
              </motion.div>
              <h1 className="font-display" style={{ fontSize: 28, fontWeight: 800, margin: "0 0 8px" }}>
                {isLogin ? "Welcome back" : "Create your account"}
              </h1>
              <p className="app-text2" style={{ fontSize: 14.5, margin: 0 }}>
                {isLogin ? "Sign in to keep building ATS-ready resumes" : "Start building ATS-optimized resumes in minutes"}
              </p>
            </div>
            ...
            {/* Google */}
            <motion.button onClick={googleAuth} disabled={loading} className="btn btn-secondary auth-google-btn"
              style={{ width: "100%", justifyContent: "center", padding: "13px", fontSize: 15, fontWeight: 600, borderRadius: 10 }}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10, marginTop: 24, paddingTop: 24, borderTop: "1px solid var(--c-border)" }}>
              {["No credit card required", "Free to get started", "Your data stays private"].map(item => (
                <div key={item} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13 }} className="app-text2">
                  <span style={{ width: 18, height: 18, borderRadius: "50%", background: "var(--c-accent2-light)", color: "var(--c-accent2)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    <Icon.Check size="3" />
                  </span>
                  {item}
                </div>
            ...
            <div style={{ textAlign: "center", marginTop: 24, fontSize: 14 }} className="app-text2">
